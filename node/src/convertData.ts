...
const symbolsData = JSON.parse(fs.readFileSync('../lambdaData/symbolsData.json') as any) as Dictionary<SymbolData>
// const fxProRawData = JSON.parse(fs.readFileSync('./data.json') as any) as Dictionary<Dictionary<Price>>
...
//   result.volatility.unshift(Math.abs(priceData.high - priceData.low))
//
...
//     result.volatility = result.last20High.slice(0, INPUT_DEEP)
//   }
//
//   const dataForSet = ({
//     date: priceData.date,
